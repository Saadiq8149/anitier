                ...
                <div className="tierlist-container">
                    <div className="tierlist-header">
                        ...
                        <div className="tier-actions">
                            <button className="btn btn-outline" onClick={() => setViewListMode(true)}>
                                View List
                            </button>
                                            ...
                                            tier.animes.map((anime) => {
                                                return (
                                                    <div className="tier-item" key={anime.id}
                                                        ...
                                                        onMouseLeave={() => setTierHoveredIndex(null)}
                                                    >
                                                        <img className="anime-tier-cover" src={anime.coverImage.large} alt={anime.title.english || anime.title.romaj}  onDragStart={(e) => handleTierItemDragStart(anime, e)}/>
                                                        {tierHoveredIndex === anime.id && (
                                                            <div className="anime-title modal-overlay card">
                                                                {anime.title.english || anime.title.romaji}
                                                            </div>
